...
const BASH_SCRIPT = `
# Lean Hermes Obsidian Plugin (Terminal) - shell integration for bash
...
const ZSH_SCRIPT = `
# Lean Hermes Obsidian Plugin (Terminal) - shell integration for zsh
...
const PWSH_SCRIPT = `
# Lean Hermes Obsidian Plugin (Terminal) - shell integration for PowerShell
