...
const BASH_SCRIPT = `
# Hermes Console for Obsidian Plan - shell integration for bash
...
const ZSH_SCRIPT = `
# Hermes Console for Obsidian Plan - shell integration for zsh
...
const PWSH_SCRIPT = `
# Hermes Console for Obsidian Plan - shell integration for PowerShell
