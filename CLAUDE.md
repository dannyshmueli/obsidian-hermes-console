...
Stored in the Obsidian vault at `$VAULT_PATH/01 Projects/LP Products/Lean Hermes Obsidian Plugin (Terminal)/`. Includes Epics, User Stories, NFRs, and Test Cases following the standard artifact format.
