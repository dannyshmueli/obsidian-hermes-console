...
Stored in the Obsidian vault at `$VAULT_PATH/01 Projects/LP Products/Hermes Console for Obsidian Plan/`. Includes Epics, User Stories, NFRs, and Test Cases following the standard artifact format.
